...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_APP_URL || "https://himtatwa.com",
  ),
  title: {
  ...
  openGraph: {
    ...
    description:
      "Premium liquid Shilajit drops sourced from 16,000+ feet in the Himalayas.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Himtatwa Shilajit",
      },
    ],
  },
  twitter: {
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: ["https://www.instagram.com/himtatwa"],
            }),
          }}
        />
        <script
            ...
            __html: JSON.stringify([
              {
                ...
                image: "https://himtatwa.com/images/Product_img_redesigned.png",
                description:
                  "Pure Himalayan Shilajit in liquid dropper form. Sourced from 16,000+ feet. Lab-tested, FSSAI certified, zero additives.",
              ...
              },
              {
                ...
                image: "https://himtatwa.com/images/Product_img_redesigned.png",
                description:
                  "Best-value pure Himalayan Shilajit in liquid dropper form. 3-4 month supply. Lab-tested, FSSAI certified.",
                brand: { "@type": "Brand", name: "Himtatwa" },
                sku: "HT-50ML",
                offers: {
                  "@type": "Offer",
