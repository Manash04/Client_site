...
export const PRODUCTS: Product[] = [
  {
    ...
    ingredients:
      "Pure Himalayan Shilajit Extract — zero additives, zero fillers",
    usage:
      "Add 3–5 drops to warm water or milk. Consume daily on an empty stomach for best results.",
    certifications: [
      "Lab Tested",
      "FSSAI Certified",
      "No Additives",
  ...
  },
  {
    ...
    slug: "himtatwa-liquid-shilajit-50ml",
    description:
...
export const BENEFITS_DATA = [
  {
    ...
    title: "Boost Energy",
    description:
      "Natural ATP production for sustained energy throughout the day without crashes.",
  },
  {
    icon: "Brain",
    title: "Brain Function",
    description:
      "Enhanced cognitive performance, focus, and mental clarity with fulvic acid.",
  },
  {
    icon: "TrendingUp",
    title: "Testosterone",
    description:
      "Clinically shown to support healthy testosterone levels in men naturally.",
  },
  {
    icon: "Clock",
    title: "Anti-Aging",
    description:
      "85+ minerals and antioxidants that combat cellular aging and promote longevity.",
  },
  {
    icon: "Shield",
    title: "Immunity",
    description:
      "Strengthen your body's natural defence system with adaptogenic properties.",
  },
  {
    icon: "Heart",
    title: "Heart Health",
    description:
      "Support cardiovascular function and maintain healthy blood pressure levels.",
  },
];
...
export const FAQ_DATA = [
  {
    ...
    answer:
      "Shilajit is a natural substance found primarily in the rocks of the Himalayas, formed over centuries by the gradual decomposition of plants. It's rich in fulvic acid and contains 85+ minerals in ionic form, making it one of the most potent natural supplements available.",
  },
  {
    question: "How do I use Himtatwa Liquid Shilajit?",
    answer:
      "Simply add 3–5 drops to a glass of warm water or milk. Consume once daily, preferably on an empty stomach in the morning. For best results, maintain consistent daily usage for at least 2–3 months.",
  },
  {
    question: "Is it safe to consume daily?",
    answer:
      "Yes, Himtatwa Liquid Shilajit is 100% natural, lab-tested, and FSSAI certified. It contains zero additives or fillers. However, we recommend consulting your physician if you have any pre-existing medical conditions or are on medication.",
  },
  {
    question: "How long before I see results?",
    answer:
      "Most users report increased energy within the first 1–2 weeks. For full benefits including improved cognitive function and hormonal balance, we recommend consistent use for 2–3 months.",
  },
  {
    question: "What makes Himtatwa different from other brands?",
    answer:
      "Himtatwa sources Shilajit from altitudes above 16,000 feet in the Himalayas, ensuring maximum potency. Our liquid form offers superior bioavailability compared to resin or capsules. Every batch is lab-tested for purity and heavy metals.",
  },
  {
    question: "Do you offer returns or refunds?",
    answer:
      "Yes, we offer a 30-day satisfaction guarantee. If you're not happy with the product, contact us for a full refund. The product must be at least 50% unused.",
  },
];
